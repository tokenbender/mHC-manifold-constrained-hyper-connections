...
run_variant() {
  ...
  local config="$2"
  local out_dir="$3"
  local log_path="${LOG_DIR}/t4-tiny-${name}.log"
...
run_variant "baseline" "config/train_fineweb10B_tiny_t4.py" "out-t4-tiny-baseline"
run_variant "hc" "config/train_fineweb10B_hc_tiny_t4.py" "out-t4-tiny-hc"
run_variant "mhc" "config/train_fineweb10B_mhc_tiny_t4.py" "out-t4-tiny-mhc"
